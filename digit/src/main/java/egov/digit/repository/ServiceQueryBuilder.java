...
import egov.digit.models.Pagination;
import egov.digit.models.ServiceCriteria;
...
public class ServiceQueryBuilder {
    ...
    static final String INSERT_SERVICE = "INSERT INTO service (id, tenantId, serviceDefId, referenceId, createdBy, lastModifiedBy, createdTime, lastModifiedTime, additionalDetails, accountId, clientId) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?::jsonb, ?, ?)";
    static final String INSERT_SERVICE_ATTRIBUTE= "INSERT INTO service_attribute_value (id, referenceId, attributeCode, value, createdBy, lastModifiedBy, createdTime, lastModifiedTime, additionalDetails) VALUES (?, ?, ?, ?::jsonb, ?, ?, ?, ?, ?::jsonb)";
    ...
    public String getServiceIdsQuery(ServiceSearchRequest serviceSearchRequest, List<Object> preparedStmtList) {
        ...
        query.append(" FROM service service ");
    ...
    public String getServiceSearchQuery(ServiceCriteria criteria, List<Object> preparedStmtList) {
        StringBuilder query = new StringBuilder("SELECT service.id, service.tenantid,  service.servicedefid, service.referenceid, service.createdby, service.lastmodifiedby, service.createdtime, service.lastmodifiedtime, service.additionaldetails, service.accountid, service.clientid, "
                ...
                + "INNER JOIN service_attribute_value as attribute_value ON "
